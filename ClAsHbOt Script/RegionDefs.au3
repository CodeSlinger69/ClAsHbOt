...
Global $rLiveReplayEndScreenReturnHomeButton[8] = [13, 458, 93, 538, 55, 493, 0xf8cbb6, 6]
Global $rWindowVilliageWasAttackedOkayButton[8] = [450, 385, 574, 434, 475, 422, 0x5eac10, 6]
...
Global $rArmyCampInfoButton1[8] = [443, 459, 501, 517, 464, 481, 0x387cb0, 0]
Global $rArmyCampInfoButton2[8] = [403, 459, 460, 517, 425, 481, 0x387cb0, 0]
