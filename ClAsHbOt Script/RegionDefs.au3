...
Global $BarracksPanelTrainTroops1Button[8] = [600, 455, 666, 522, 632, 483, 0x708cb0, 6]
Global $BarracksPanelTrainTroops2Button[8] = [641, 455, 708, 522, 673, 486, 0x708cb0, 6]  ; x1, x2 might need to be adjusted after 2015-04-30 update
Global $BarracksPanelTrainTroops3Button[8] = [560, 455, 627, 522, 594, 486, 0x708cb0, 6]  ; x1, x2 might need to be adjusted after 2015-04-30 update
