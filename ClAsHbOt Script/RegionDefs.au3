...
Global $rShieldIsActivePopupButton[8] = [522, 305, 644, 355, 484, 348, 0xc83c10, 6] ; TEST 5/7
...
Global $rBarracksPanelTrainTroops2Button[8] = [641, 455, 708, 522, 673, 486, 0x708cb0, 6] ; TEST 5/7 ; x1, x2 might need to be adjusted after 2015-04-30 update
Global $rBarracksPanelTrainTroops3Button[8] = [560, 455, 627, 522, 594, 486, 0x708cb0, 6] ; TEST 5/7  ; x1, x2 might need to be adjusted after 2015-04-30 update
Global $rBarracksPanelUpgradingButton[8] = [560, 455, 627, 522, 569, 515, 0x6eb40a, 6] ; TEST 5/7
...
Global $rWindowBarracksSpellsColor1[4] = [339, 271, 0x0958f2, 6] ; colored
Global $rWindowBarracksSpellsColor2[4] = [339, 271, 0x515151, 6] ; grayed-out
