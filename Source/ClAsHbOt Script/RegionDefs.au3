...
Global $rAndroidBackButton_BlueStacks[8] = [29, 702, 62, 718, 0, 0, 0, 0] ; button is semi-transparent, can't use color effectively
Global $rAndroidBackButton_MEmu[8] = [290, 747, 313, 758, 0, 0, 0, 0]
