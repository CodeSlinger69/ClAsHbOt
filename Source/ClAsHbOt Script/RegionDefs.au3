...
Global $rBarracksTroopBox[10] = [120, 321, 729, 520]
Global $rBarracksButtonOffset[4] = [0, 5, 87, 56]
Global $rBarracksWindowTextBox[10] = [122, 178, 286, 190, 0xffffff, 9, 0, 0, 0, 0]
Global $rArmyOverviewWindowTextBox[10] = [143, 175, 275, 190, 0x494949, 60, 0, 0, 0, 0]
Global $rArmyOverviewTroopTimeRemainingTextBox[10] = [675, 176, 725, 186, 0x766A52, 70, 732, 182, 0xFFFFFF, 0]
...
Global $rTrainTroopsWindowDequeueButton[8] = [554, 201, 572, 216, 563, 207, 0xFFFFFF, 0]
