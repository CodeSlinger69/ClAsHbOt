Func ReadSettings()
   ...
   $gDonateMatchTroopStrings[$eTroopArcher] = IniRead($gIniFile, "Donate", "Archer Match Strings", "arch")
   $gDonateMatchTroopStrings[$eTroopGoblin] = IniRead($gIniFile, "Donate", "Goblin Match Strings", "gob")
   $gDonateMatchTroopStrings[$eTroopGiant] = IniRead($gIniFile, "Donate", "Giant Match Strings", "giant")
   $gDonateMatchTroopStrings[$eTroopWallBreaker] = IniRead($gIniFile, "Donate", "Wall Breaker Match Strings", "break")
   $gDonateMatchTroopStrings[$eTroopBalloon] = IniRead($gIniFile, "Donate", "Balloon Match Strings", "loon")
   $gDonateMatchTroopStrings[$eTroopWizard] = IniRead($gIniFile, "Donate", "Wizard Match Strings", "wiz")
   $gDonateMatchTroopStrings[$eTroopHealer] = IniRead($gIniFile, "Donate", "Healer Match Strings", "heal")
   $gDonateMatchTroopStrings[$eTroopDragon] = IniRead($gIniFile, "Donate", "Dragon Match Strings", "drag")
   $gDonateMatchTroopStrings[$eTroopPekka] = IniRead($gIniFile, "Donate", "Pekka Match Strings", "pekka|pkka")
   $gDonateMatchTroopStrings[$eTroopMinion] = IniRead($gIniFile, "Donate", "Minion Match Strings", "minion")
   $gDonateMatchTroopStrings[$eTroopHogRider] = IniRead($gIniFile, "Donate", "Hog Rider Match Strings", "hog")
   $gDonateMatchTroopStrings[$eTroopValkyrie] = IniRead($gIniFile, "Donate", "Valkyrie Match Strings", "valk")
   $gDonateMatchTroopStrings[$eTroopGolem] = IniRead($gIniFile, "Donate", "Golem Match Strings", "golem")
   $gDonateMatchTroopStrings[$eTroopWitch] = IniRead($gIniFile, "Donate", "Witch Match Strings", "witch")
   $gDonateMatchTroopStrings[$eTroopLavaHound] = IniRead($gIniFile, "Donate", "Lava Hound Match Strings", "lava|hound")
   $gDonateMatchTroopStrings[$eTroopBowler] = IniRead($gIniFile, "Donate", "Bowler Match Strings", "bowler")
